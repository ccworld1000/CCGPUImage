...
Pod::Spec.new do |spec|
  ...
  spec.author             = { "CC (deng you hua)" => "ccworld1000@gmail.com" }
  # Or just: spec.author    = "CC (deng you hua)"
  # spec.authors            = { "CC (deng you hua)" => "ccworld1000@gmail.com" }
  ...
  spec.source       = { :git => "https://github.com/ccworld1000/CCGPUImage.git", :tag => "#{spec.version}" }
  ...
  spec.ios.exclude_files = 'framework/Source/Mac'
  spec.ios.frameworks   = ['OpenGLES', 'CoreMedia', 'QuartzCore', 'AVFoundation']

  spec.osx.exclude_files = 'framework/Source/iOS',
  ...
  spec.resources = "framework/Resources/*.png"
